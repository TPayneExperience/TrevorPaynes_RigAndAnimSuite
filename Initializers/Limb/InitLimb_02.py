...
class InitLimb(absInit.Abstract_Initializer):
    ...
    def Initialize(limb):
        ...
        # pm.addAttr(limb, ln='bhvHasPhysics', at='bool', dv=0, h=hide)
        # pm.addAttr(limb, ln='physicsGroups', dt='string', h=hide)

        # #============= ATTRS ============================

        # limbTypes = ':'.join(rigData.LIMB_TYPES)
        # limbSides = ':'.join(rigData.LIMB_SIDES)
        # limbLocations = ':'.join(rigData.LIMB_LOCATIONS)
        ...
        # pm.addAttr(limb, ln='limbLocation', at='enum', 
        #                                     en=limbLocations, h=hide)
